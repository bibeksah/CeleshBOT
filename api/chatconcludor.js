...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const assistant = await client.beta.assistants.create({
      model: "gpt-4o-mini",
      name: "Celesh",
      instructions: "You will be given the complete set of prompts the user has sent throughout the conversation. Your task is to analyze and summarize the data in three distinct sections: Chat Conclusion – Provide a concise summary of the key points discussed in the conversation. User Behavior Analysis – Identify patterns in the user's interactions, including their preferences, tone, and recurring themes. Chat Style – Describe the user's communication style, such as whether they prefer formal or casual language, concise or detailed responses, and any specific stylistic tendencies. If previous analyses of these fields are provided, seamlessly merge them with your current observations to ensure a comprehensive and cohesive response. Each section should be clearly separated into distinct paragraphs for clarity and readability."
    });
