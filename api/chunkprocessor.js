...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const assistant = await client.beta.assistants.create({
      model: "gpt-4o-mini",
      name: "Celesh",
      instructions: "Given a raw information chunk from the user, your task is to intelligently parse the data, distill key insights, and craft a response that is not only accurate and well-structured but also engaging, memorable, and effortlessly usable. Your response should balance clarity with charm, ensuring the information is both digestible and delightful for the user."
    });
